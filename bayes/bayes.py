...
print(iris_x)
iris_x = iris_x[:, 0:2]  # 取前两个特征值
# iris_x = iris_x[:, 2:4]  # 取前后个特征值
print(iris_x)
...
plt.xlabel(u'花萼长度', fontsize=14)  # plt.xlabel(u'花瓣长度', fontsize=14)
plt.ylabel(u'花萼宽度', fontsize=14)  # plt.xlabel(u'花瓣长度', fontsize=14)
plt.title(u'鸢尾花数据的分类结果', fontsize=18)
plt.grid(True)
