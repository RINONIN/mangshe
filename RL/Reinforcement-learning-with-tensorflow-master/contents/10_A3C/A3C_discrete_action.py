        ...
        if scope == GLOBAL_NET_SCOPE:   # get global network
            ...
            with tf.compat.v1.variable_scope(scope):
                ...
                with tf.compat.v1.name_scope('a_loss'):
                    log_prob = tf.compat.v1.reduce_sum(tf.compat.v1.log(self.a_prob + 1e-5) * tf.compat.v1.one_hot(self.a_his, N_A, dtype=tf.compat.v1.float32), axis=1, keep_dims=True)
