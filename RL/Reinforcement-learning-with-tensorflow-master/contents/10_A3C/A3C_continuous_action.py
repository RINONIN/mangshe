...
class ACNet(object):
        ...
        if scope == GLOBAL_NET_SCOPE:   # get global network
            ...
            with tf.compat.v1.variable_scope(scope):
                ...
                with tf.compat.v1.name_scope('choose_a'):  # use local params to choose action
                    self.A = tf.compat.v1.clip_by_value(tf.compat.v1.squeeze(normal_dist.sample(1), axis=[0, 1]), A_BOUND[0], A_BOUND[1])
    ...
    def _build_net(self, scope):
        ...
        with tf.compat.v1.variable_scope('actor'):
            ...
            sigma = tf.compat.v1.layers.dense(l_a, N_A, tf.compat.v1.nn.softplus, kernel_initializer=w_init, name='sigma')
