...
class DeepQNetwork:
    def __init__(
        ...
        self._build_net()
        # 替换 target net 的参数
        t_params = tf.compat.v1.get_collection('target_net_params')  # 提取 target_net 的参数
        e_params = tf.compat.v1.get_collection('eval_net_params')  # 提取  eval_net 的参数
        self.replace_target_op = [tf.compat.v1.assign(t, e) for t, e in zip(t_params, e_params)]  # 更新 target_net 参数
